...
contract OrganizationImplTest is Test {
    ...
    */
    ...
    //         orgImpl.addOrganization(cnpj, orgName, Organization.OrganizationType.Associate, canVote);
    //     }
    // }
    ...
    // Organization.OrganizationType newType,
    // bool newCanVote
    // ) public {
    //     console.log(">>>>> [FUZZY] testFuzz_AddOrganization");
    //     vm.assume(caller != address(0));
    ...
    //         console.log(">>>>> [FUZZY] !isGovernance");
    //         vm.expectRevert(abi.encodeWithSelector(Governable.UnauthorizedAccess.selector, caller));
    //         orgImpl.updateOrganization(orgId, newCnpj, newName, newType, newCanVote);
    //     } else {
    //         if (!orgExists) { 
